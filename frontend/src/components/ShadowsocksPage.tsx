  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 shadow dark:shadow-slate-950/20 rounded-lg p-6">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">Shadowsocks Configuration</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500 dark:text-slate-400">Cipher</label>
            <p className="text-lg font-semibold text-gray-900 dark:text-slate-100">{config?.cipher || 'N/A'}</p>
          </div>
        </div>
      </div>
