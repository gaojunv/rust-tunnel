...
use super::ApiState;
use crate::reverse_proxy::ProxyRule;
...
pub async fn create_proxy_rule(
    ...
    let rule_type = match body.rule_type.to_lowercase().as_str() {
        "http" => crate::reverse_proxy::RuleType::Http,
        "tcp" => crate::reverse_proxy::RuleType::Tcp,
        "udp" => crate::reverse_proxy::RuleType::Udp,
        "llm" => crate::reverse_proxy::RuleType::Llm,
        _ => {
            return (
    ...
    if let Err(e) = crate::reverse_proxy::validate_rule_for_save(&rule) {
        return (StatusCode::BAD_REQUEST, e).into_response();
    }
    crate::reverse_proxy::sanitize_rule(&mut rule);

    let cert_status = crate::reverse_proxy::resolve_cert_source_for_rule(
        &rule,
    ...
    if rule.rule_type == crate::reverse_proxy::RuleType::Http {
        if let Err(e) = state
            .server_state
            .proxy_state
...
pub async fn delete_proxy_rule(
    ...
    if deleted.rule_type != crate::reverse_proxy::RuleType::Http
        && deleted.rule_type != crate::reverse_proxy::RuleType::Llm
    {
        let listener_handle = {
...
pub async fn update_reverse_proxy_config(
    ...
    // Update in-memory
    {
        ...
        dc.reverse_proxy = crate::dynamic_config::ReverseProxySettings {
