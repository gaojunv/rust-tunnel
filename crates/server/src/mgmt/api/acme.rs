                ...
                Some(config) => {
                    let solver: Arc<dyn crate::acme::dns::DnsChallengeSolver> =
                        match config.provider {
                            crate::acme::dns::DnsProvider::Aliyun => {
                                Arc::new(crate::acme::dns::aliyun::AliyunDnsSolver::new(config))
                            }
                            crate::acme::dns::DnsProvider::Cloudflare => Arc::new(
                                crate::acme::dns::cloudflare::CloudflareDnsSolver::new(config),
                            ),
                            crate::acme::dns::DnsProvider::TencentCloud => {
                                Arc::new(crate::acme::dns::tencent::TencentDnsSolver::new(config))
                            }
                            crate::acme::dns::DnsProvider::Custom => {
                                Arc::new(crate::acme::dns::custom::CustomDnsSolver::new(config))
                            }
                        };
